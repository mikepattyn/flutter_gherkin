...
class GivenOpenDrawer extends Given1WithWorld<String, FlutterWorld> {
  ...
  Future<void> executeStep(String action) async {
    ...
    final isOpen = await FlutterDriverUtils.isPresent(world.driver, drawerFinder);
    ...
    if (isOpen && action == "close") {
      ...
      await world.driver?.scroll(drawerFinder, -300.0, 0.0, const Duration(milliseconds: 300));
