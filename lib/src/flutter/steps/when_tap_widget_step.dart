...
class WhenTapWidget extends When1WithWorld<String, FlutterWorld> {
  @override
  RegExp get pattern => RegExp(r"I tap the {string} [button|element|label|icon|field|text|widget]");

  @override
  Future<void> executeStep(String key) async {
    await FlutterDriverUtils.tap(world.driver, find.byValueKey(key), timeout: timeout! * .9);
  }
}
